...
function fireNSpecialProjectile(){
    neutralSpecialProjectile.set(match.createProjectile("local::annieCharacter.PcrescentcutChara", self));
...
function initialize(){
    ...
    burstHud = Sprite.create("annieBurstMeter");
